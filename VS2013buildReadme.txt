...
3) When everything in place open in VS 2013 ffmpeg_deps.sln located in SMP folder and build it in Release config. 
For additional build instructions please consult ffmpeg readme - yasm is necessary
It will create static libraries located in ../msvc/lib/x64 or ../msvc/lib/x86 folder and the headers necessary for include in ../msvc/include
