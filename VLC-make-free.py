...
# GPL
gplItems = [ 'access_realrtsp_plugin', 'dshow_plugin', 'dtv_plugin', 'dvdnav_plugin', 'dvdread_plugin', 'rtp_plugin', 'wasapi_plugin', 'dts_plugin', 'faad_plugin', 'mpeg2_plugin', 't140_plugin', 'x264_plugin', 'x265_plugin', 'gestures_plugin', 'hotkeys_plugin', 'oldrc_plugin', 'win_hotkeys_plugin', 'mpc_plugin', 'real_plugin', 'sid_plugin', 'qt4_plugin', 'skins2_plugin', 'lua_plugin', 'audioscrobbler_plugin', 'export_plugin', 'libfile_logger_plugin', 'liblogger_plugin', 'stats_plugin', 'vod_rtsp_plugin', 'podcast_plugin', 'sap_plugin', 'upnp_plugin', 'stream_out_duplicate_plugin', 'stream_out_rtp_plugin', 'stream_out_stats_plugin', 'atmo_plugin', 'deinterlace_plugin', 'hqdn3d_plugin', 'motionblur_plugin', 'motiondetect_plugin', 'postproc_plugin', 'remoteosd_plugin', 'rotate_plugin', 'glspectrum_plugin', 'goom_plugin', 'projectm_plugin', 'visual_plugin' ]
